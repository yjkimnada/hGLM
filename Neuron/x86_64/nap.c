...
extern "C" {
 ...
 static void _hoc_calcMinf(void);
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "calcMinf_nap", _hoc_calcMinf,
 0, 0
};
 /* declare global and static user variables */
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "mtau_nap", 1e-12, 1e+09,
 0,0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nap /Users/yjkimnada/hGLM/Neuron/x86_64/nap.mod\n");
...
static int calcMinf(_threadargsprotocomma_ double);
...
static int  calcMinf ( _threadargsprotocomma_ double _lv ) {
   minf = 1.0 / ( 1.0 + exp ( - ( _lv - Vh - sh ) / k ) ) ;
    return 0; }
...
static void _hoc_calcMinf(void) {
  ...
  _nt = nrn_threads;
 _r = 1.;
 calcMinf ( _p, _ppvar, _thread, _nt, *getarg(1) );
 hoc_retpushx(_r);
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/yjkimnada/hGLM/Neuron/nap.mod";
static const char* nmodl_file_text = 
