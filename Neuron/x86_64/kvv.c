...
#define nrn_init _nrn_init__kvv
#define _nrn_initial _nrn_initial__kvv
#define nrn_cur _nrn_cur__kvv
#define _nrn_current _nrn_current__kvv
#define nrn_jacob _nrn_jacob__kvv
#define nrn_state _nrn_state__kvv
#define _net_receive _net_receive__kvv 
#define _f_trates _f_trates__kvv 
#define rates rates__kvv 
#define states states__kvv 
#define trates trates__kvv 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kvv", _hoc_setdata,
 "rates_kvv", _hoc_rates,
 "trates_kvv", _hoc_trates,
 0, 0
};
...
#define tha tha_kvv
 double tha = 60;
#define tadj tadj_kvv
 double tadj = 0;
#define temp temp_kvv
 double temp = 23;
#define usetable usetable_kvv
 double usetable = 1;
#define vmax vmax_kvv
 double vmax = 100;
#define vmin vmin_kvv
 double vmin = -120;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kvv /Users/yjkimnada/hGLM/Neuron/x86_64/kvv.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 75 in file kvv.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/yjkimnada/hGLM/Neuron/kvv.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
